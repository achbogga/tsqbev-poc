...
The current repository targets a narrower goal than a full production stack. It aims to provide a public, minimal, evidence-grounded implementation with a clear path from model code to export, TensorRT conversion, and measured latency. The autonomous research loop remains intentionally disabled in this phase. The implementation, scripts, and measured artifacts live in the public \texttt{tsqbev-poc} repository~\cite{repo}.
